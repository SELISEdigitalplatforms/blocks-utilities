...
import { ISaveMagicUrlConfigPayload } from "@blocks-utilities/magic-url/models/magic-url-config.model";
import { useGetMagicUrlConfig } from "@blocks-utilities/magic-url/hooks/use-magic-url";
import { useQueryClient } from "@tanstack/react-query";
import { showErrorToast, showSuccessToast } from "@/hooks/use-toast";
import { getDefaultShortUrlBase, isValidUrl } from "@blocks-utilities/magic-url/utils/url.util";
