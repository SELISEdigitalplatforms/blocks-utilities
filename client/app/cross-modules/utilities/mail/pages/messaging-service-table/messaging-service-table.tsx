...
import { IMessagingServiceData } from "@blocks-utilities/mail/models/messaging";
...
import {
  ...
  configurations,
  protocols,
} from "@blocks-utilities/mail/constants/messaging";
import { MessagingTableToolbar } from "@blocks-utilities/mail/components/messaging/messaging-table-toolbar/messaging-table-toolbar";
...
export function MessagingServiceTable() {
  ...
  const handleRowClick = (messageId: number | string) => {
    navigate(`/messaging/campaigns/${messageId}`);
  };
