...
interface TraceGuideLineProps {
  steps: Step[];
}

export const TraceGuideLine = ({ steps }: TraceGuideLineProps) => {
  ...
  return (
    <div className="flex flex-1 flex-col justify-between overflow-hidden">
      <div className="flex-1 overflow-y-auto p-4 text-sm text-medium-emphasis">
