...
export const USER_ENDPOINTS = {
  ...
  GET_USER: `${API_BASES.LOGIC}${IAM_SUBPATH}/user`,
  ...
  GET_SESSIONS: `${API_BASES.LOGIC}${IAM_SUBPATH}/GetSessions`,
  GET_HISTORIES: `${API_BASES.LOGIC}${IAM_SUBPATH}/GetHistories`,
  GET_USER_CODES: `${API_BASES.LOGIC}${AUTH_SUBPATH}/GetUserCodes`,
