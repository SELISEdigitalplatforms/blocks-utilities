...
public sealed class CheckoutApiPaymentCaptureProviderGateway :
        ...
        CancellationToken cancellationToken)
    {
        ...
        var baseUri = new Uri(
            provider.ApiBaseUrl.EndsWith('/')
                ...
                : provider.ApiBaseUrl + "/");
        var path =
            $"payments/{Uri.EscapeDataString(originalPaymentPspReference)}/captures";
        ...
        {
            return new PaymentCaptureProviderResult(
                PaymentCaptureProviderOutcome.Timeout);
        }
        catch (OperationCanceledException)
        {
            throw;
